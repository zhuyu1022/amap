 ...
 */
public class MIP_HanziToPinyin
{
    
    private static LinkedHashMap<String, Integer> spellMap;
    
    private static MIP_HanziToPinyin              sInstance;
    
    public static MIP_HanziToPinyin getInstance()
    {
        synchronized (MIP_HanziToPinyin.class)
        {
            if (sInstance != null)
            {
                return sInstance;
            }
            sInstance = new MIP_HanziToPinyin();
