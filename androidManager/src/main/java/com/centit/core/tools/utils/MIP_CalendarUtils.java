 ...
 * 
 */
public class MIP_CalendarUtils
{
    private Calendar cal;
    
    private MIP_CalendarUtils()
    {
        this.cal = Calendar.getInstance();
    }
    
    public static MIP_CalendarUtils getInstance()
    {
        return new MIP_CalendarUtils();
    }
    
    public static MIP_CalendarUtils getInstance(String year, String month)
    {
        MIP_CalendarUtils th = new MIP_CalendarUtils();
        if (year != null && !year.equals("") && !year.equals("null") && month != null && !month.equals("")
            && !month.equals("null"))
        {
    ...
    public static MIP_CalendarUtils getInstance(String year, String month, String day)
    {
        MIP_CalendarUtils th = new MIP_CalendarUtils();
        if (year != null && !year.equals("") && !year.equals("null") && month != null && !month.equals("")
            && !month.equals("null") && day != null && !day.equals("") && !day.equals("null"))
        {
            th.cal.set(Calendar.YEAR, Integer.parseInt(year));
            th.cal.set(Calendar.MONTH, Integer.parseInt(month) - 1);
     ...
     * @return
     */
    public static MIP_CalendarUtils getInstance(int year, int month, int day)
    {
        MIP_CalendarUtils th = new MIP_CalendarUtils();
     ...
     */
    public static MIP_CalendarUtils getInstance(String date_time)
    {
    ...
    public static MIP_CalendarUtils getInstance(long timeInMillis)
    {
        MIP_CalendarUtils th = new MIP_CalendarUtils();
        th.set(timeInMillis);
        return th;
    ...
    public String getYearSimpleStr()
    {
        ...
        return MIP_StringUtils.addPrefixZero(year);
    ...
    {
        return MIP_StringUtils.addPrefixZero(this.getMonth());
    }
    ...
    {
        return MIP_StringUtils.addPrefixZero(this.getDay());
    }
    ...
    {
        return MIP_StringUtils.addPrefixZero(this.getHour());
    }
    ...
    {
        return MIP_StringUtils.addPrefixZero(this.getMinute());
    }
    ...
    {
        return MIP_StringUtils.addPrefixZero(this.getSecond());
    }
    ...
    {
        MIP_CalendarUtils previousDay = getTimeHandlerPrevious();
    ...
    {
        MIP_CalendarUtils nextDay = getTimeHandlerNext();
     ...
     * @return
     */
    public MIP_CalendarUtils getTimeHandlerPrevious()
    {
        long todayTimeInMillis = this.getTimeInMillis();
        MIP_CalendarUtils previousDay = MIP_CalendarUtils.getInstance(todayTimeInMillis - 24 * 3600 * 1000l);
        return previousDay;
    }
     ...
     * @return
     */
    public MIP_CalendarUtils getTimeHandlerNext()
    {
        long todayTimeInMillis = this.getTimeInMillis();
        MIP_CalendarUtils nextDay = MIP_CalendarUtils.getInstance(todayTimeInMillis + 24 * 3600 * 1000l);
        return nextDay;
    }
    ...
    public String getYYYYMMPrevious()
    {
        ...
        StringBuffer sbf = new StringBuffer();
        sbf.append(year).append("-").append(MIP_StringUtils.addPrefixZero(previousMonth));
        return sbf.toString();
    }
    ...
    public String getYYYYMMNext()
    {
        ...
        StringBuffer sbf = new StringBuffer();
        sbf.append(year).append("-").append(MIP_StringUtils.addPrefixZero(nextMonth));
        return sbf.toString();
    }
    ...
    {
        return MIP_CalendarUtils.getInstance().getTimestamp().toString().substring(0, 19);
    }
    ...
    public String getPeriodStr(long timeInMillis)
    {
        ...
        if (result > 0)
        {
            sbf.append(MIP_StringUtils.addPrefixZero((int)result)).append(":");
        ...
        sbf.append(MIP_StringUtils.addPrefixZero((int)result));
        return sbf.toString();
    }
    
    public static MIP_CalendarUtils linuxTimeToWinTime(MIP_CalendarUtils timeHandler)
    {
    ...
    public static String formatDate(int year, int month, int day)
    {
        ...
        sbf.append(year);
        sbf.append("-");
        sbf.append(MIP_StringUtils.addPrefixZero(month + 1));
        sbf.append("-");
        sbf.append(MIP_StringUtils.addPrefixZero(day));
        return sbf.toString();
    }
