...
public class CrashHandler implements UncaughtExceptionHandler
{
    ...
    public void uncaughtException(Thread thread, Throwable ex)
    {
        ...
        // final Activity activity = GlobalState.getInstance().getmActivityList().get(0);
        // // 收集设备参数信息
    ...
    private String saveCrashInfo2File(Throwable ex)
    {
        ...
        sb.append("/*********" + MIP_TimeUtils.getCurrentStr(MIP_TimeUtils.yyyyMMddHHmm) + "**********/" + "\n");
        ...
        try
        {
            String fileName = "cmipcrash_" + MIP_TimeUtils.getCurrentStr(MIP_TimeUtils.yyyyMMddHHmm) + ".txt";
            if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED))
            {
                String path = Constant_Mgr.GETMIP_CRASH_DIR();
