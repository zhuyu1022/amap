 ...
 * History:
 */
public class MIP_TextStyle
{
    
    private SpannableString spannableString;
    
    public MIP_TextStyle()
    {
    }
    
    public MIP_TextStyle(String str)
    {
    ...
    public MIP_TextStyle setForegroundColor(int Color, int start, int end)
    {
        if (spannableString == null)
        {
            return this;
    ...
    public MIP_TextStyle setBackgroundColor(int Color, int start, int end)
    {
        if (spannableString == null)
        {
            return this;
    ...
    public MIP_TextStyle setUnderlineSpan(int start, int end)
    {
        if (spannableString == null)
        {
            return this;
