...
public class ResultDetailResponse implements Serializable
{
    ...
    /****/
    private List<ResultDetailItemResponse> results          = new ArrayList<ResultDetailItemResponse>();
     ...
     * @author wl
     */
    public List<ResultDetailItemResponse> getResults()
    {
        return results;
    }
     ...
     * @author wl
     */
    public void setResults(List<ResultDetailItemResponse> results)
    {
