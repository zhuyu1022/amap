 ...
 * 
 */
public class DownloadFileFromServerWrapRequest extends BaseWrapRequest
{
    
    private FileInfo mfileInfo;
    
    public DownloadFileFromServerWrapRequest(int type, String url, FileInfo fileinfo)
    {
        super(url, type);
    ...
    {
        mDownloadEntityHandler = new FileDownloadWithURLHandleEntity(mfileInfo.getFilepath());
    }
